...
This firmware and control panel are part of internal development work for **OBSIDIA Semiconductors** and related robotics / R&D projects.  
Usage should follow your internal agreements and policies.

---

If you’d like, future enhancements could include:

- JSON/REST API endpoints  
- WebSocket live streaming of servo telemetry  
- Multi-servo support (bus scan and per-ID control)  
- Logging to SD card  
- Integration with the REELScan TFT UI / main system
